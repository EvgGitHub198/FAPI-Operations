...
from fastapp.database import get_session
from fastapp import tables, models
from fastapp.models.operations import OperationType, OperationCreate, OperationUpdate
...
class OperationsService:
    ...
    def _get(self, user_id, operation_id: int) -> tables.Operation:
        operation = (
            self.session
    ...
    def get_list(self, user_id: int, type: Optional[OperationType] = None) -> List[tables.Operation]:
        query = (self.session.
                 query(tables.Operation)
