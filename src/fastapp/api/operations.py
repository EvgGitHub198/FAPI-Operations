...
from fastapp.models.auth import User
from fastapp.services.auth import get_current_user
from fastapp.services.operations import OperationsService
from fastapp.models.operations import Operation, OperationType, OperationCreate, OperationUpdate
...
def get_operations(
    ...
    return service.get_list(user_id=user.id, type=type)
